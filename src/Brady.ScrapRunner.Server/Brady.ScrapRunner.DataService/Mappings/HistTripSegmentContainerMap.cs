...
{
    /// <summary>
    /// An HistTripSegmentContainer mapping to NHibernate.
    /// </summary>
    public class HistTripSegmentContainerMap : ClassMapping<HistTripSegmentContainer>
    {
        public HistTripSegmentContainerMap()
        {
            Table("HistTripSegmentContainer");
            ...
            Property(x => x.Id, m =>
            {
                m.Formula("concat(HistSeqNo, ';', TripNumber, ';', TripSegContainerSeqNumber, ';',TripSegNumber )");
                m.Insert(false);
                m.Update(false);
            });
