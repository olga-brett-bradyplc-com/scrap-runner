...
{
    public class HistTripSegmentMap : ClassMapping<HistTripSegment>
    {
        public HistTripSegmentMap()
        {

            Table("HistTripSegment");
            ...
            Property(x => x.Id, m =>
            {
                m.Formula("concat(HistSeqNo, ';', TripNumber, ';', TripSegNumber)");
                m.Insert(false);
                m.Update(false);
            });
