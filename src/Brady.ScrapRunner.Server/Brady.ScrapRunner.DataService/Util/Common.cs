    ...
    public class Common
    {
            ...
            IEnumerable<long> userRoleIdsEnumerable, string userCulture, ILog log, out DataServiceFault fault)
        {
            ...
            var driverHistory = new DriverHistory()
            {
                ...
                ServicesFlag = driverStatus.ServicesFlag
            };

            if (currentTripSegment != null)
            {
                driverHistory.DestCustType = currentTripSegment.TripSegDestCustType;
                driverHistory.DestCustTypeDesc = currentTripSegment.TripSegDestCustTypeDesc;
                driverHistory.DestCustHostCode = currentTripSegment.TripSegDestCustHostCode;
                driverHistory.DestCustName = currentTripSegment.TripSegDestCustName;
                driverHistory.DestCustAddress1 = currentTripSegment.TripSegDestCustAddress1;
                driverHistory.DestCustAddress2 = currentTripSegment.TripSegDestCustAddress2;
                driverHistory.DestCustCity = currentTripSegment.TripSegDestCustCity;
                driverHistory.DestCustState = currentTripSegment.TripSegDestCustState;
                driverHistory.DestCustZip = currentTripSegment.TripSegDestCustZip;
                driverHistory.DestCustCountry = currentTripSegment.TripSegDestCustCountry;
            }
             ...
             int callCountThisTxn, out DataServiceFault fault)
        {
            ...
            foreach (var tripSegmentContainer in tripSegmentContainerList)
            {
                ...
                histTripSegmentContainer.TripSegContainerDriverNotes = tripSegmentContainer.TripSegContainerDriverNotes;
