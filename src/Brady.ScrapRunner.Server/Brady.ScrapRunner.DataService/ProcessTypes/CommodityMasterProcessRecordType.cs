...
namespace Brady.ScrapRunner.DataService.ProcessTypes
{
                ...
                <CommodityMasterProcess, string, CommodityMasterProcessValidator, CommodityMasterProcessDeletionValidator>
    {
        ...
        protected new static readonly ILog log = LogManager.GetLogger(typeof(CommodityMasterProcess));
        ...
        {
            // Capture details of incoming request for logging at the INFO level
