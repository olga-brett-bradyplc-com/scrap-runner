...
1.  Run the ScrapTest 20160527bwf1.EXE in this folder to unite the split files into one ScrapTest 20160527bwf.zip file.  GSplit does not have to be downloaded in order to unite the files.
